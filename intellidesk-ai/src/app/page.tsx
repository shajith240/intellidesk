...
import {
  Mail, Cpu, MessageSquareReply, BookOpen, ShieldCheck, BarChart3,
} from "lucide-react";

const processItems = [
  { icon: Mail, title: "Email Ingestion", description: "Automatic Capture" },
  { icon: Cpu, title: "AI Classification", description: "Smart Routing & Priority" },
  { icon: MessageSquareReply, title: "Response Generation", description: "AI-Drafted Replies" },
  { icon: BookOpen, title: "Knowledge Base", description: "Self-Learning Context" },
  { icon: ShieldCheck, title: "SLA Tracking", description: "Quality Assurance" },
  { icon: BarChart3, title: "Analytics & Reports", description: "Performance Insights" },
];

const SectionGlow = ({ className = "" }: { className?: string }) => (
  <div className={`relative w-full h-px pointer-events-none ${className}`} aria-hidden="true">
