...
export function Header() {
	...
	return (
		<header
			className={cn('fixed top-0 left-0 right-0 z-50 w-full border-b border-transparent', {
		...
		>
			<nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4">
				...
				<div className="hidden items-center gap-2 md:flex">
					...
					<a href="/login" className={buttonVariants({ variant: "outline" })}>Sign In</a>
					<a href="/signup" className={buttonVariants({})}>Get Started</a>
				</div>
				<Button
					size="icon"
					variant="outline"
			...
			<MobileMenu open={open} className="flex flex-col justify-between gap-2">
				...
				<div className="flex flex-col gap-2">
					<a href="/login" className={buttonVariants({ variant: "outline" }) + " w-full bg-transparent"}>Sign In</a>
					<a href="/signup" className={buttonVariants({}) + " w-full"}>Get Started</a>
				</div>
			</MobileMenu>
		</header>
	);
